/*
    Copyright (c) 2016 VNGIoTLab, All rights reserved.
...
PinName Pin_nRF51822_to_Arduino(uint32_t pin)
{
	...
	{	
		...
		case 1 : return_pin = P0_10;break;//D1/TX
		case 2 : return_pin = P0_20;break;//D2
		case 3 : return_pin = P0_19;break;//D3
		case 4 : return_pin = P0_18;break;//D4
		case 5 : return_pin = P0_17;break;//D5
		case 6 : return_pin = P0_16;break;//D6
		case 7 : return_pin = P0_9;break;//D7
		//J10
		case 8 : return_pin = P0_21;break;//D8
		case 9 : return_pin = P0_22;break;//D9
		case 10 : return_pin = P0_23;break;//D10              SS
		case 11 : return_pin = P0_24;break;//D11              MOSI
		case 12 : return_pin = P0_25;break;//D12              MISO
		case 13 : return_pin = P0_28;break;//D13              SCK           
		
		case 20 : return_pin = P0_29;break;//D20              SDA0
		case 21 : return_pin = P0_30;break;//D21              SCL0
		...
		case 18 : return_pin = P0_5;break;//A4  //SDA1
		case 19 : return_pin = P0_6;break;//A5	//SCL1
    
    case 22: return_pin = P0_7; break;          //LED
		
		default : return_pin = (PinName)NC;break;		
	}
	
#endif
/////////////chua xem truong hop cua BLE_NANO: NAM/////////////////////////
/*#ifdef BLE_NANO
	switch(pin)
	{	
