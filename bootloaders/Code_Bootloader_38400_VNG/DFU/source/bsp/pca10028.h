...
#define SER_APP_TX_PIN              10    // UART TX pin number.
#define SER_APP_CTS_PIN             9    // UART Clear To Send pin number.
...
#define SER_CON_TX_PIN              10    // UART TX pin number.
#define SER_CON_CTS_PIN             9     // UART Clear To Send pin number. Not used if HWFC is set to false.
